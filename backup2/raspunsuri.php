...
<head><title>Unealta studentului - Raspunsuri</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                </li> <!-- Pagina cu quizuri pt examene -->                <?php
                if ($auth)
...
<section class="topcontent" id="questions">
    <div class="row">
    <div id="intrebari" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
<h2><?php include_once 'phplib/qa.php'; $grup=$_GET['grup']; echo getCat($grup); ?>:</h2>

<?php

if (isset($_GET['page'])) $page=$_GET['page'];
	else $page=1;
showReplies($grup,$page);
?>
</div>
    </div>
    <div class="row">
        ...
        <?php if ($auth) : ?>
            ...
            <label for="postmesage"><h2>Raspunde:</h2></label>
            <p id="confirm"></p>
            <form class="input-group" style="margin-bottom: 1em">
                <input type="hidden" id="grup" value="<?php echo $grup; ?>" name="grup">
                <textarea id="postmesage" class="form-control" style="margin-bottom: 1em" placeholder="Adauga raspunsul tau..."></textarea>
                <input type="button" class="btn btn-primary" value="Raspunde" onclick="postanswer()">
            </form>
            </div>
        <?php endif?>
        </div>
