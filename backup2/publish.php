...
<head><title>Unealta studentului - Publica</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<input type="text" name="titlu" id="titlu" class="form-control"></div><br>
<div class="input-group">
<label for="continut">Continut(suporta HTML):</label>
<textarea name="continut" id="continut" class="form-control" rows="20" cols="80"></textarea></div><br>
<h4 id="ajaxanswer"></h4><br>
<script src="javascripts/ajax.js"></script>
<input type="button" class="btn btn-primary" onclick="publishArticle()" value="Publica">
</form>		
		';
            else
