...
<head><title>Schimbare parola</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        <form>
            <label for="parolaveche">Parola veche:</label><br>
            <div class="input-group col-sm-8 col-md-6 col-lg-4">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <input type="password" name="parolaveche" id="parolaveche" class="form-control">
            </div>
            <label for="parolanoua">Parola noua:</label><br>
            <div class="input-group col-sm-8 col-md-6 col-lg-4">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <input type="password" name="parolanoua" id="parolanoua" class="form-control">
            </div>
            <label for="confirmare">Confirmare parola:</label><br>
            <div class="input-group col-sm-8 col-md-6 col-lg-4">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <input type="password" name="confirmare" id="confirmare" class="form-control">
            </div><br>
            <h4 id="ajaxanswer"></h4><br>
            <input type="button" onclick="changePass()" value="Schimbare parola" class="btn btn-primary">
        </form>
    </section>
