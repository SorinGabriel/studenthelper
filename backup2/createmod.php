...
<head><title>Creeare moderator</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/createmod.php" method="post" onsubmit="return createmod()">
                <div class="input-group"><label for="ncat">Username:</label><input id="username" class="form-control" name="username" type="text"></div>
                <h5 style="color:red;display:none" id="validatorusername">Nu ati introdus userul</h5>
                <div class="checkbox"><label><input id="articole" name="articole" type="checkbox" value="1">Moderator articole</label></div>
                <div class="checkbox"><label><input id="qa" name="qa" type="checkbox" value="1">Moderator QA</label></div>
                <div class="checkbox"><label><input id="chestionare" name="chestionare" type="checkbox" value="1">Moderator chestionare</label></div>
                <h5 style="color:red;display:none" id="validatormod">Nu ati selectat tipul de moderator</h5><br>
