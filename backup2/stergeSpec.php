...
<head><title>Stergere specializare</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/deleteSpec.php" onsubmit="return deleteSpec()" method="post">
                <div class="input-group"><label for="facultate">Facultate:</label><?php include_once 'phplib/facilities.php'; selectFac2(); ?></div>
                <div class="input-group" id="specDiv" style="display:none">
                    <label for="specializare">Specializare:</label>
                </div>
                <h5 id="validatorspec" style="color:red;display:none">Nu ati ales specializarea</h5><br>
                <br><input type="submit" class="btn btn-danger" value="Sterge"></form>
            <?php
