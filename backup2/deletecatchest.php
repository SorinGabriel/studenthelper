...
<head><title>Sterge categorie chestionar</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/deletechestcat.php" method="post">
                <div class="input-group"><label for="categorie">Alege categoria:</label><?php include_once 'phplib/chestionare.php'; selectCAT();?></div><br>
                <input type="submit" class="btn btn-danger" value="Sterge"></form>
            <?php
