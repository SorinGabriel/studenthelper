...
<head><title>Anulare link lost password</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        <h4>
            ...
            if (destroyLinkLp($key))
                echo 'Linkul a fost anulat';
            else
                echo 'Ceva nu a mers corect';
            ?>
        </h4>
    </section>
