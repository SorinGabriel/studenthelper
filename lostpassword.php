...
<head><title>Parola pierduta</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        <form>
            <div class="input-group"><label for="mail">Adresa de mail:</label><input type="email" placeholder="Adresa de mail asociata contului" class="form-control" id="mail" name="mail"></div><br>
            <h4 id="ajaxanswer"></h4><br>
            <input type="button" onclick="lostPass()" value="Trimite link de resetare" class="btn btn-primary">
        </form>
    </section>
