...
<head><title>Adaugare categorie chestionare</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script src="javascripts/autocompleteurl.js"></script>
</head>
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/createchestcat.php" method="post">
                <div class="input-group"><label for="ncat">Nume categorie:</label><input id="ncat" name="ncat" type="text" class="form-control" value="Nume categorie" onkeyup="autocomp()"></div><br>
                <div class="input-group"><label for="url">Url categorie:</label><input id="url" name="url" type="text" class="form-control" value="nume-categorie"></div><br>
