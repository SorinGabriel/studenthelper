...
<head><title>Stergere grupa</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/deleteGrupa.php" onsubmit="return deletegroup()" method="post">
                <div class="input-group"><label for="facultate">Facultate:</label><?php include_once 'phplib/facilities.php'; selectFac(); ?></div>
                ...
                <h5 id="validatorgrupa" style="color:red;display:none">Nu ati ales grupa</h5><br>
                <br><input class="btn btn-danger" type="submit" value="Sterge"></form>
            <?php
