...
<head><title>Adaugare facultate</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
        ?>
        <form action="phpscripts/insertFacultate.php" method="post" onsubmit="return createFac()">
            <div class="input-group"><label for="facultate">Nume facultate:</label><input id="facultate" name="facultate" type="text" class="form-control"></div>
            <h5 id="validatorfac" style="color:red;display:none">Nu ati completat numele facultatii</h5><br>
