...
<head><title>Schimbare mail</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="author" content="Marica Sorin">
    <meta name="title" content="Schimbare mail">
...
<div class="container-fluid">
    ...
    <section id="mesajdeintampinare" class="row jumbotron">
        <form>
            <label for="mailvechi">Mail vechi:</label><br>
            <div class="input-group col-sm-8 col-md-6 col-lg-4">
                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                <input type="email" id="mailvechi" class="form-control" value="<?php echo getMail($_SESSION['user'],0); ?>" disabled>
            </div>
            <label for="mailnou">Mail nou:</label><br>
            <div class="input-group col-sm-8 col-md-6 col-lg-4">
                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                <input type="email" id="mailnou" name="mailnou" class="form-control" placeholder="(Ex: sorinmarica4@gmail.com)">
            </div>
            <label for="confirm">Confirmare mail:</label><br>
            <div class="input-group col-sm-8 col-md-6 col-lg-4">
                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                <input type="email" id="confirm" name="confirm" class="form-control" placeholder="Reintroduceti mail-ul de deasupra">
            </div><br>
            <p id="ajaxanswer"></p>
            <input type="button" class="btn btn-primary" onclick="changeMail()" value="Modifica">
        </form>
    </section>
