...
<head><title>Stergere categorie QA</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/deleteqacat.php" method="post">
                <div class="input-group"><label for="categorie">Alege categoria:</label><?php include_once 'phplib/qa.php'; selectQA();?></div><br>
