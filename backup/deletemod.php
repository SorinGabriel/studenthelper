...
<head><title>Stergere moderator</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/deletemod.php" method="post">
                <div class="input-group"><label for="moderator">Alege moderator:</label><?php include_once 'phplib/admin.php'; selectMod();?></div><br>
