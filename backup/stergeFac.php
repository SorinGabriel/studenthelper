...
<head><title>Stergere facultate</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container-fluid">
    ...
    <section id="questions" class="topcontent well">
        ...
        if ($auth && $userrole==1) :
            ?>
            <form action="phpscripts/deleteFac.php" onsubmit="return addSpec()" method="post">
                <div class="input-group"><label for="facultate">Nume facultate:</label><?php include_once 'phplib/facilities.php'; selectFac3();?></div>
                <h5 id="validatorfac" style="color:red;display:none">Nu ati ales facultatea</h5><br>
