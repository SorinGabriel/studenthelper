...
<head><title>Cautare</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
?>
    ...
    <div class="row">
<section id="results" class="col-sm-6 col-sm-offset-3">
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#users">Utilizatori gasiti</a></li>
		<li><a data-toggle="tab" href="#articole">Articole gasite</a></li>
		<li><a data-toggle="tab" href="#qa">Intrebari si raspunsuri gasite</a></li>
	</ul>
	
	<div class="tab-content">
		<div id="users" class="tab-pane fade in active">
			<?php
			searchuser($info,1,10);
			?>
		</div>
		<div id="articole" class="tab-pane fade">
			<?php
			searcharticole($info,1,10);
			?>
		</div>
