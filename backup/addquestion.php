...
<head><title>Adaugare intrebare</title><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
?>
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="qanda.php"><span class="glyphicon glyphicon-question-sign"></span>Q&A</a>
                    ...
                    </li> <!-- Pagina cu quizuri pt examene --><!-- Pagina cu quizuri pt examene -->
                    <?php
                    if ($auth)
    ...
    <div class="row">
<section id="questions" class="topcontent well col-sm-6 col-sm-offset-3">
<h2>Adauga o intrebare noua:</h2>
<article>
<form action="phpscripts/postqa.php" method="post" class="input-group">
<label for="subiect">Subiect:</label><input type="text" class="form-control" name="subiect" id="subiect"><br>
<label for="mesaj">Mesaj:</label><textarea class="form-control" name="mesaj" id="mesaj"></textarea><br>
<label for="categorie">Categorie:</label><?php selectQA(); ?><br><br>
